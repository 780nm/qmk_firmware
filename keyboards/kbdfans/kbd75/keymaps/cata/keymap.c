...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //QWERTY Base
  [_QW] = LAYOUT_ansi(
    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PGUP,  KC_PGDN,  TD(BLD),
  ...
  [_FN] = LAYOUT_ansi(
    KC_PWR,   KC_SLEP,  KC_WAKE,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_BRIU,  KC_BRID,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_PSCR,  KC_PAUS,  KC_SLCK,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MUTE,  KC_VOLD,  KC_VOLU,            XXXXXXX,  KC_NLCK,
    XXXXXXX,  XXXXXXX,  KC_MS_U,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,
    XXXXXXX,  KC_MS_L,  KC_MS_D,  KC_MS_R,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                      TD(BLD),  XXXXXXX,
    XXXXXXX,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,            KC_WH_U,  KC_APP,
...
void post_process_record_user(uint16_t keycode, keyrecord_t *record) {
  if (keycode == NK_TOGG) rgblight_blink_layer(keymap_config.nkro ? 3 : 4, 500);
}
...
void dance_build (qk_tap_dance_state_t *state, void *user_data) {
    switch (state->count) {
        case 1:
            ...
            rgblight_blink_layer(4, 10000);
            break;
        case 2:
            SEND_STRING(SS_LCTL(SS_LSFT(SS_TAP(X_B))));
            rgblight_blink_layer(3, 10000);
            break;
        default:
